...
/** @type {string} */
const CACHE_VERSION = '1780281588|18570957';
/** @type {string} */
const CACHE_PREFIX = 'OpenBlox-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'OpenBlox.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["OpenBlox.html","OpenBlox.js","OpenBlox.offline.html","OpenBlox.icon.png","OpenBlox.apple-touch-icon.png","OpenBlox.audio.worklet.js","OpenBlox.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["OpenBlox.wasm","OpenBlox.pck"];
